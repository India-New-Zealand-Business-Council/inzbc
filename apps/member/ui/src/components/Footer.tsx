...
// apps/comms/ui, apps/sip/ui and apps/fta/ui's Footer.tsx (no shared package between the apps
// yet — each app under apps/*/ui is an independent pnpm workspace package).
const SOCIAL_LINKS = [
